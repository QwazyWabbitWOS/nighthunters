...
GAME_OBJS = \
	...
	m_tank.o performance.o p_client.o p_hud.o p_trail.o  p_view.o p_weapon.o \
	q_shared.o strsep.o \
	flashlight.o g_cmd_misc.o g_cmd_observe.o g_cmd_overload.o \
	g_cmd_scopetoggle.o g_cmd_setup.o g_cmd_spotrep.o g_cmd_teleport.o \
	g_ctf.o g_cvars.o g_flare.o g_IRgoggles.o g_lightning.o g_nh.o \
	g_nh_light.o g_safety.o p_menu.o p_motd.o p_nhmenu.o p_nhscoreboard.o \
	p_predator.o q_devels.o q_model.o
