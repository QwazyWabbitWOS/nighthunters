...
void InitGame(void)
{
	...
	predator_model = gi.cvar("predator_model", DEFAULT_PREDATOR_MODEL, CVAR_LATCH);
	validatePredatorModel();
	predator_skin = gi.cvar("predator_skin", DEFAULT_PREDATOR_SKIN, CVAR_LATCH);
	validatePredatorSkin();

	marine_allow_custom = gi.cvar("marine_allow_custom", "1", CVAR_SERVERINFO | CVAR_LATCH);
	marine_model = gi.cvar("marine_model", DEFAULT_MARINE_MODEL, CVAR_SERVERINFO | CVAR_LATCH);
	validateMarineModel();
	marine_skin = gi.cvar("marine_skin", DEFAULT_MARINE_SKIN, CVAR_SERVERINFO | CVAR_LATCH);
	validateMarineSkin();
	initSkins();
